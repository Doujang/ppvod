...
<div class="row ff-row">
  <div class="col-md-8 ff-col">
    <div class="page-header">
      ...
      <?php echo ($feifeilist); ?>
      <span class="pull-right"><a href="<?php echo ff_url('vod/type',array('id'=>$list_id,'type'=>$feifeilist,'area'=>'','year'=>'','star'=>'','state'=>'','order'=>'addtime','p'=>1),true);?>" class="btn btn-success btn-xs">更多</a></span>
      </h2>
    </div>
    <!--循环图片 -->
