...
$(document).ready(function(){
	$(".user-forget-form").on('submit',function(e){
		$.ajax({
...
<body>
<div class="container ff-user-login">
<div class="row">
<div class="col-sm-8 col-sm-offset-2">
  ...
  <h5 class="text-center">
    ...
    <a class="ff-text" href="{:ff_url('user/login')}">用户登录</a>
  ...
  <div class="col-sm-12">
    ...
    <form class="form-horizontal user-forget-form" action="{:ff_url('user/forgetpost')}" method="post" role="form" target="_blank">
      ...
      <div class="form-group">
        ...
        <div class="col-xs-12 text-center">
          <button type="submit" class="btn ff-btn-play" id="user-submit">找回密码</button>
        </div>
      </div>
  	</form>
