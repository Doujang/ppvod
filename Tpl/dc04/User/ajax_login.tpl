  ...
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
        	<form class="form-horizontal user-login-forum" action="{:ff_url('user/loginpost')}" method="post" role="form" target="_blank">
            ...
            <div class="form-group">
              ...
              <div class="col-xs-5">
                ...
                <a class="btn ff-btn-play" href="{:ff_url('user/register')}">注册</a>
              </div>
            </div>
          </form>
