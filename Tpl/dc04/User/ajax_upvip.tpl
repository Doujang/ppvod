...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-body text-center">
      <form class="form-inline user-upvip-form" action="{:ff_url('user/deadtime')}" method="post" role="form" target="_blank" style="padding:20px 0">
        ...
        <button type="submit" class="btn ff-btn-play">提交</button>
      </form>
    </div>
