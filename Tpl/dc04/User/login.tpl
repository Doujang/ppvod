...
<div class="col-md-8 col-md-offset-2">
  ...
  <div class="col-xs-12">
    ...
    <form class="form-horizontal" id="ff-login" action="{:ff_url('user/loginpost')}" method="post" role="form" target="_blank">
      ...
      <div class="form-group">
        ...
        <div class="col-xs-5">
          <button type="submit" class="btn ff-btn-play" id="user-submit">登录</button>
        </div>
      </div>
  	</form>
    <h6 id="user-alert">
