<php>$item_list = ff_mysql_vod('cid:'.$type_id.';tag_name:'.$type_type.';tag_list:vod_type;area:'.$type_area.';year:'.implode(',',str_split($type_year,4)).';actor:'.$type_star.';state:'.$type_state.';ispay:'.$type_ispay.';page_p:'.$type_page.';page_is:true;page_id:type;limit:24;cache_name:default;cache_time:default;order:vod_'.$type_order.';sort:desc');
