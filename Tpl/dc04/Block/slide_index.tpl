<php>$item_slide = ff_mysql_slide('limit:8;cache_name:default;cache_time:default;order:slide_oid;sort:asc');</php>
<div class="carousel slide" id="ff-slide" data-interval="{$Think.config.ui_slide_index}">
  <!-- 轮播（Carousel）指标 -->
