...
<link rel="stylesheet" href="{$tpl_path}system.css?{%feifeicms_version}">
...
};</script><script type="text/javascript" src="https://cdn.bootcss.com/jquery/1.11.3/jquery.min.js"></script>
<script type="text/javascript" src="https://cdn.bootcss.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
<script type="text/javascript" src="{$public_path}js/system.js?{%feifeicms_version}"></script>
<script type="text/javascript" src="{$tpl_path}system.js?{%feifeicms_version}"></script>
<!--[if lt IE 9]>
