<form class="navbar-form navbar-right ff-search" data-sid="{$site_sid}" role="search" action="{$root}index.php?s=vod-search-name" method="post">
  <div class="input-group input-group-sm">
    ...
    <div class="input-group-addon">
      ...
      <span class="glyphicon glyphicon-record ff-text"></span>
      </a>
    </div>
    </gt>
