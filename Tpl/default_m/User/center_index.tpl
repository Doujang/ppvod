...
<div class="row">
  <div class="col-xs-12 ff-col">
    ...
    <dl class="safe">
      <dt>我的影币</dt>
      <dd>影币可用来支付付费点播影片或购买VIP权限 您现在拥有（{$user_score|default=0}）个影币 <a href="javascript:;" class="btn btn-success btn-sm user-pay">充值影币</a></dd>  
      <dt>VIP权限</dt>
      <dd>VIP权限到期后将不能观看付费影片，您的VIP到期时间为（{$user_deadtime|date='Y/m/d',###}）<a href="javascript:;" class="btn btn-success btn-sm user-upvip">续期VIP</a></dd>
      <dt>登录邮箱</dt>
      <dd>{$user_email} <a href="javascript:;" class="btn btn-success btn-sm user-change-email">修改邮箱</a></dd>
      <dt>用户密码</dt>
