...
<div class="container">
  <div class="page-header">
    <h2><span class="glyphicon glyphicon-menu-right ff-text"></span> 我想看的影片</h2>
  </div>
    ...
    <div class="text-center">
      <ul class="pager">
        <gt name="user_page" value="1">
          <li><a id="ff-prev" href="{:ff_url('user/center', array('action'=>'wish','p'=>($user_page-1)), true)}">上一页</a></li>
        </gt>
        <lt name="user_page" value="$totalpages">
          <li><a id="ff-next" href="{:ff_url('user/center', array('action'=>'wish','p'=>($user_page+1)), true)}">下一页</a></li>
        </lt>
       </ul> 
    </div>
  </gt>
