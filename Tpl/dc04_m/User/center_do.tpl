<php>
$item_vod = ff_mysql_record('sid:1;uid:'.$user_id.';type:4;group:record_did;limit:30;page_is:true;page_id:record;page_p:'.$user_page.';cache_name:default;cache_time:default;order:record_id;sort:desc');
...
<div class="row ff-row">
  <div class="col-xs-12">
    <div class="page-header">
      <h4><span class="glyphicon glyphicon-menu-right ff-text"></span> 我正在看的影片</h4>
    </div>
