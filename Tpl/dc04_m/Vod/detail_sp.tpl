  ...
  <ul class="list-unstyled ff-row">
    <div class="embed-responsive embed-responsive-4by3" id="cms_player">
      <div id="cms-player-vip">
        ...
        <iframe class="embed-responsive-item cms-player-iframe" src="{:ff_url('vod/vip',array('action'=>'play','id'=>$vod_id,'sid'=>1,'pid'=>1))}" width="100%" height="100%" frameborder="0"></iframe>
      </div>
    </div>
  </ul>
  <ul class="list-unstyled ff-row ff-player-tool">
    <li class="col-xs-7 ff-col"><include file="Base:vod_updown" /></li>
    <li class="col-xs-5 ff-col text-nowrap"><include file="Base:vod_score" /></li>
  </ul>
</div>
<!-- -->
